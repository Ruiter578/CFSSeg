...
MODEL_CHECKPOINT='./log_s3dis/log_ours_s3dis_cv0_tasks10-1'
TASKS='10-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --save_path "$MODEL_CHECKPOINT" --model_checkpoint_path "$MODEL_CHECKPOINT"
...
MODEL_CHECKPOINT='./log_s3dis/log_ours_s3dis_cv1_tasks10-1'
TASKS='10-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --save_path "$MODEL_CHECKPOINT" --model_checkpoint_path "$MODEL_CHECKPOINT"
...
MODEL_CHECKPOINT='./log_scannet/log_ours_scannet_cv0_tasks17-1'
TASKS='17-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --save_path "$MODEL_CHECKPOINT" --model_checkpoint_path "$MODEL_CHECKPOINT"
...
MODEL_CHECKPOINT='./log_scannet/log_ours_scannet_cv1_tasks17-1'
TASKS='17-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --save_path "$MODEL_CHECKPOINT" --model_checkpoint_path "$MODEL_CHECKPOINT"
