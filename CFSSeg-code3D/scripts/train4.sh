...
TASKS='10-1'
BASE_MODEL_PATH='./log_s3dis/log_ewc_s3dis_cv0_tasks10-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
TASKS='8-1'
BASE_MODEL_PATH='./log_s3dis/log_ewc_s3dis_cv0_tasks8-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
TASKS='10-1'
BASE_MODEL_PATH='./log_s3dis/log_ewc_s3dis_cv1_tasks10-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
TASKS='8-1'
BASE_MODEL_PATH='./log_s3dis/log_ewc_s3dis_cv1_tasks8-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
# TASKS='17-1'
# BASE_MODEL_PATH='./log_scannet/log_ewc_scannet_cv0_tasks17-1'
# CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
# TASKS='15-1'
# BASE_MODEL_PATH='./log_scannet/log_ewc_scannet_cv0_tasks15-1'
# CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
# TASKS='17-1'
# BASE_MODEL_PATH='./log_scannet/log_ewc_scannet_cv1_tasks17-1'
# CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
# TASKS='15-1'
# BASE_MODEL_PATH='./log_scannet/log_ewc_scannet_cv1_tasks15-1'
# CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
