...
# TASKS='10-1'
# BASE_MODEL_PATH='./log_s3dis/log_ours_s3dis_cv0_tasks10-1'
# CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
TASKS='10-1'
BASE_MODEL_PATH='./log_s3dis/log_ours_s3dis_cv1_tasks10-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
# TASKS='17-1'
# BASE_MODEL_PATH='./log_scannet/log_ours_scannet_cv0_tasks17-1'
# CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
...
# the 'for step in range(0, STEP):' -> 'for step in range(1, STEP):' in runs/train_ours.py for only incre model training
TASKS='15-1'
BASE_MODEL_PATH='./log_scannet/log_ours_scannet_cv1_tasks15-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"


TASKS='17-1'
BASE_MODEL_PATH='./log_scannet/log_ours_scannet_cv1_tasks17-1'
CUDA_VISIBLE_DEVICES=$GPU_ID python main.py "${args[@]}" --cvfold $SPLIT --tasks "${TASKS}" --base_model_checkpoint_path "${BASE_MODEL_PATH}"
