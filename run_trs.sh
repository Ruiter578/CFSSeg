...
TASK="15-5"
LR_POLICY="poly"
SUBPATH="${SUBPATH:-20260622_buffer8216_step1_32_run2}"      # default: today's date, output/save directory under checkpoints/    SUBPATH="${SUBPATH:-$(date +%Y%m%d)}" 
BASE_SUBPATH="${BASE_SUBPATH:-20260621_baseline_bs16_16}"   # default: 20260606, load step0 DeepLab checkpoint when START_STEP=1
METHOD="acil"
SETTING="sequential"
TRAIN_EPOCH=50
